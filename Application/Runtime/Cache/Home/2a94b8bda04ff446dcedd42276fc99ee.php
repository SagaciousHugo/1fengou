...
<html lang="zh-CN">
    <head>
        ...
        <!-- common css -->
        <link rel="stylesheet" type="text/css" href="/1fengou_demo/Public/css/common.css">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="http://localhost/1fengou_demo/index.php/home/Index/index/page/index"><i class="fa fa-circle-o"></i> 1分购</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> 每日精选</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="http://localhost/1fengou_demo/index.php/home/Index/createProduct">
            ...
            <li>
                <a href="http://localhost/1fengou_demo/index.php/home/Index/index/page/manage">
      ...
      <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <a href="#" class="small-box-footer">更多推荐 <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
        ...
        <section class="col-lg-7 connectedSortable">
          <div>
            ...
            <div name="product_detail">
              <?php if(is_array($productList)): $i = 0; $__LIST__ = $productList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="info">
                  <img width="150" height="150" src="/1fengou_demo/Public/<?php echo ($vo['thumbnail']); ?>" alt="商品缩略图"/>
            ...
            <div class="box-footer text-black">
              <div class="row">
                <div class="col-sm-6">
                  <!-- Progress bars -->
                  <div class="clearfix">
                    <span class="pull-left">我的关注1</span>
                    <small class="pull-right">已售90%</small>
                  </div>
                  <div class="progress xs">
                  ...
                  <div class="clearfix">
                    <span class="pull-left">我的关注2</span>
                    <small class="pull-right">已售70%</small>
                  </div>
                  <div class="progress xs">
                ...
                <div class="col-sm-6">
                  <div class="clearfix">
                    <span class="pull-left">我的关注3</span>
                    <small class="pull-right">已售60%</small>
                  </div>
                  <div class="progress xs">
                  ...
                  <div class="clearfix">
                    <span class="pull-left">我的关注4</span>
                    <small class="pull-right">已售40%</small>
                  </div>
                  <div class="progress xs">
            ...
            <div class="box-footer no-border">
              <div class="row">
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  ...
                  <div class="knob-label">北美</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center" style="border-right: 1px solid #f4f4f4">
                  <div id="sparkline-2"></div>
                  <div class="knob-label">欧洲</div>
                </div>
                <!-- ./col -->
                <div class="col-xs-4 text-center">
                  <div id="sparkline-3"></div>
                  <div class="knob-label">澳洲</div>
                </div>
                <!-- ./col -->
              </div>
              <!-- /.row -->
