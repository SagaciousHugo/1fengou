...
<html lang="zh-CN">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="queryProduct.html"><i class="fa fa-circle-o"></i> 1分购</a></li>
                    <li><a href="index2.html"><i class="fa fa-circle-o"></i> 每日精选</a></li>
                </ul>
            </li>
            <li class="treeview">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                <li><a href="#"><i class="fa fa-dashboard"></i> 商城首页</a></li>
