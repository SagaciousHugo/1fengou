...
<!--        &lt;!&ndash;jquery-validate&ndash;&gt;
    ...
    <script type="text/javascript">
        ...
        function productSearch(searchType){
            var serID = $("#queryID").val();
            var serName = $("#queryName").val();
            var serPrice = $("#queryPrice").val();
                                               ...
                                               <!-- &lt;!&ndash;暂时勿删&ndash;&gt;
                                                <div class="input-group-btn">
                                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        按ID查询 <span class="caret"></span>
                                                    </button>
                                                    <ul class="dropdown-menu dropdown-menu-right">
                                                        <li><a href="javascript:productSearch('byId')">按ID查询</a></li>
                                                        <li><a href="javascript:productSearch('byName')">按名称查询</a></li>
                                                        <li><a href="javascript:productSearch('byPrice')">按价格查询</a></li>
                                                    </ul>
                                                </div>-->
